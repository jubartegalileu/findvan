...
4. Smoke de rotas de UI (`/dashboard`, `/scraper`, `/leads`, `/whatsapp`, `/campaigns`).
5. Smoke visual automatizado com screenshots das 5 rotas principais.
...
- `/tmp/findvan-qa-e2e-smoke/<run_id>/screenshots/campaigns.png`

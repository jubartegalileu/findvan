...
Acelerar a execução diária do SDR permitindo marcar lote de leads como concluído (`done`) sem operação individual por card.

## Stories

1. **30.1 — Batch done API + SDR UI integration** (`@data-engineer` + `@dev`)  
Status: `Done`

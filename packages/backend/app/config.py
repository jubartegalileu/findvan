...
ALERT_TIMEOUT_SECONDS = get_env("ALERT_TIMEOUT_SECONDS", "2")
ALERT_RETRY_COUNT = get_env("ALERT_RETRY_COUNT", "1")
ALERT_COOLDOWN_SECONDS = get_env("ALERT_COOLDOWN_SECONDS", "300")
